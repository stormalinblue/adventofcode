...
DIRS = [LEFT, RIGHT, UP, DOWN, LEFT2, RIGHT2, UP2, DOWN2, LEFT3, RIGHT3, UP3, DOWN3]

UPS = set([UP, UP2, UP3])
DOWNS = set([DOWN, DOWN2, DOWN3])
LEFTS=       set([LEFT, LEFT2, LEFT3])
RIGHTS =        set([RIGHT, RIGHT2, RIGHT3])
...
with open('input17.txt') as f:
    ...
    while frontier:
        ...
        next_dirs = [
            ...
            (add(t_i, DOWN), DOWN),
            (add(t_i, LEFT2), LEFT2),
            (add(t_i, RIGHT2), RIGHT2),
            (add(t_i, UP2), UP2),
            (add(t_i, DOWN2), DOWN2),
            (add(t_i, LEFT3), LEFT3),
            (add(t_i, RIGHT3), RIGHT3),
            (add(t_i, UP3), UP3),
            (add(t_i, DOWN3), DOWN3)]
